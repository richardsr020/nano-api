...
<?php 
    ...
    */
        ...
        if(isset($_GET['chat'])){
          ...
          $contactInfos = $contact->getInfos($_GET['chat']);
...
<div id="frame">
	...
	<div id="sidepanel">
        ...
        <?php
              ...
              if(!empty($initContacts)){
                ...
                while($i < count($initContacts)){

                  ?>

                    <a href="index.php?chat=<?=$initContacts[$i]['id'];?>">
                        ...
                        <div class="wrap">
                          ...
                          <span class="contact-status online"></span>
                            ...
                            <div class="meta">
                              ...
                              <p class="name"><?=$initContacts[$i]['name'];?></p>
                ...
                <?php
                  ...
                  ?>
                    <h1>No contact exist</h1>
                    <p>Clic down 'Add contact' to add freinds</p>
                  <?php
                }
		...
		<div id="bottom-bar">
			...
			<a href="public/view/chat/newContact.php"><button id="addcontact"><i class="fa fa-user-plus fa-fw" aria-hidden="true"></i> <span>Add contact</span></button></a>

			<a href="public/view/chat/settings.php"><button id="settings"><i class="fa fa-cog fa-fw" aria-hidden="true"></i> <span>Settings</span></button></a>
	...
	<div class="content">
      ...
      <div class="contactPhoto">
        ...
        <?=(isset($contactInfos['name']))? $contactInfos['name']:"ChatBox";?>
